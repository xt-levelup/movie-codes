...
// ---------------------------------------------------------
// ------TẠO HÀM TRONG COMPONENT ContentDocumentaries.js----------
// ---------------------------------------------------------

const ContentDocumentaries = () => {
    const { documentaries, API_KEY } = useApi();
    ...
    useEffect(() => {
        const getData = async () => {
            setIsLoading(true);
            const data = await documentaries();
...
export default ContentDocumentaries;
